...
sys.path.insert(0, os.path.abspath("/data/users/jnoodle/saliency/NoiseRobustDG"))
...
def get_puzzle_mix(args, device):
    ...
    x_puzzle, ratio = mixup.mixup_graph(input1=x, grad1=sal, indices=indices, block_num=16, mean=mean, std=std, transport=True, device=device)
