...
def download_and_extract(url, dst, remove=True):
    try:
        ...
        print("Downloaded using gdown")
    except:
        print("Not able to download using gdown, please download using the browser")
