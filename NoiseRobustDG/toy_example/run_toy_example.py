...
def main():
    ...
    parser.add_argument('--toy_example_name', choices=['random_projections','no_projections', 'complete'], required=True)
...
def process_args(args):
    ...
    if args.toy_example_name=='random_projections':
        ...
        required_args = ['n', 'p_correlation', 'd_causal', 'mean_causal', 'var_causal', 'd_spurious', 'mean_spurious', 'var_spurious', 'label_noise']
        ...
        required_args = ['n', 'p_correlation', 'mean_causal', 'var_causal', 'mean_spurious', 'var_spurious', 
                         'mean_noise', 'var_noise', 'label_noise']
        random_features = False
    elif args.toy_example_name=='complete':
        data_generation_fn = generate_toy_data_complete
